    ...
    <>
      ...
      <div className="rsp-collage-wrap" style={{ position: "relative", height: 430, width: "100%" }}>
        ...
        <div className="sc" style={{ ...cardBase, top: 10, left: 0, width: 200, zIndex: 3, transform: "rotate(-3deg)" }}>
          {tapeTL}
          <div style={{ overflow: "hidden" }}><img src="/images/collage/photo-day1.png" alt="Woman beginning her first day of training at Healthify gym in Sri Vijaya Puram" /></div>
          {caption("Day 1 ✦")}
        </div>
        ...
        <div className="sc" style={{ ...cardBase, top: 0, left: 178, width: 215, zIndex: 5, transform: "rotate(2.5deg)" }}>
          {pin}
          <div style={{ overflow: "hidden" }}><img src="/images/collage/photo-2.png" alt="Healthify member staying motivated during a strength training session" /></div>
          {caption("Unstoppable 🧡")}
        </div>
        ...
        <div className="sc" style={{ ...cardBase, top: 18, right: 0, width: 192, zIndex: 3, transform: "rotate(-1.8deg)" }}>
          {tapeTR}
          <div style={{ overflow: "hidden" }}><img src="/images/collage/photo-3.png" alt="Group of women from the Healthify community in Sri Vijaya Puram" /></div>
          {caption("Our squad")}
        </div>
        ...
        <div className="sc" style={{ ...cardBase, top: 232, left: 0, width: 195, zIndex: 4, transform: "rotate(-2deg)" }}>
          {tapeTL}
          <div style={{ overflow: "hidden" }}><img src="/images/collage/photo-4.png" alt="Healthify members training together during a workout session" /></div>
        ...
        <div className="sc" style={{ ...cardBase, top: 222, left: 190, width: 200, zIndex: 6, transform: "rotate(1.5deg)" }}>
          {tapeTop}
          <div style={{ overflow: "hidden" }}><img src="/images/collage/photo-1.png" alt="Trainer guiding a member through an exercise at Healthify women’s gym" /></div>
          {caption("With us 🧡")}
        </div>
        ...
        <div className="sc" style={{ ...cardBase, top: 238, right: 0, width: 195, zIndex: 4, transform: "rotate(-1.5deg)" }}>
          {pin}
          <div style={{ overflow: "hidden" }}><img src="/images/collage/photo-5.jpeg" alt="The Healthify training team at the women’s fitness club in Sri Vijaya Puram" /></div>
          {caption("The team 🧡")}
        </div>
        ...
        <div style={{
          ...
          <motion.div
            ...
            <h1 style={{ fontFamily: "var(--font-bebas)", fontSize: "clamp(2.5rem, 5.5vw, 5.5rem)", lineHeight: 0.95, color: "#F5F0EB", margin: "0 0 24px", textAlign: "center" }}>
              <span className="sr-only">Healthify — Women Only Fitness Club in Sri Vijaya Puram (Port Blair): </span>
              EMPOWERING
              <br />
              WOMEN
              <br />

    ...
    >
      ...
      >
        {!imgError ? (
          <Image
            src={service.image}
            alt={`${service.title} class at Healthify women’s gym in Sri Vijaya Puram`}
            fill
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0d0d0d", position: "relative", overflow: "hidden" }}>
      ...
      >
        ...
        >
          <span className="sr-only">Healthify women&apos;s gym classes in Sri Vijaya Puram (Port Blair): </span>
          YOUR PROGRAM.
          <br />
